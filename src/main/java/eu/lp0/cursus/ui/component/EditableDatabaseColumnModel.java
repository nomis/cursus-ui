...
public abstract class EditableDatabaseColumnModel<T extends AbstractEntity, V, O extends Frame & DatabaseWindow> extends DatabaseColumnModel<T, V> implements
		DatabaseTableCellEditor.CellSaver<T, V> {
	private final Logger log = LoggerFactory.getLogger(getClass());
	private final O win;
	private final AbstractDAO<T> dao;

	public EditableDatabaseColumnModel(O win, AbstractDAO<T> dao) {
		this.win = win;
		this.dao = dao;
	}
