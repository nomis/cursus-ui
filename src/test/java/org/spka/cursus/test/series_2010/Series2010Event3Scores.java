...
public class Series2010Event3Scores extends Series2010Event2Scores {
	...
	private void checkSeriesAtEvent3(Scores scores) throws Exception {
		...
		race3AssertUtil.assertPilot(sco197, 0, 0, true, 14, 16);
		...
		race5AssertUtil.assertPilot(sco068, 6, 0, false, 3, 3);
		race5AssertUtil.assertPilot(sco179, 0, 0, true, 3, 4);
	...
	public final void checkEvent3() throws Exception {
		...
		try {
			...
			race5AssertUtil.assertPilot(sco159, 6, 0, false, 2, 2);
			race5AssertUtil.assertPilot(sco068, 6, 0, false, 3, 3);
			race5AssertUtil.assertPilot(sco248, 5, 0, false, 4, 4);
			race5AssertUtil.assertPilot(sco019, 4, 0, false, 5, 5);
			race5AssertUtil.assertPilot(sco018, 4, 0, false, 6, 6);
			race5AssertUtil.assertPilot(sco158, 3, 0, false, 7, 7);
			race5AssertUtil.assertPilot(sco060, 3, 0, false, 8, 8);
			race5AssertUtil.assertPilot(sco087, 3, 0, false, 9, 9);
			race5AssertUtil.assertPilot(sco116, 3, 0, false, 10, 10);
			race5AssertUtil.assertPilot(sco249, 3, 0, false, 11, 11);
			race5AssertUtil.assertPilot(sco081, 0, 0, true, 16, 12);
			race5AssertUtil.assertPilot(sco153, 0, 0, false, 16, 12);
			race5AssertUtil.assertPilot(sco179, 0, 0, true, 16, 12);
			race5AssertUtil.assertPilot(sco808, 0, 0, false, 16, 12);
			race5AssertUtil.assertDone(2);
	...
	public final void checkRace5() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(sco019, 4, 0, false, 5, 5);
			raceAssertUtil.assertPilot(sco018, 4, 0, false, 6, 6);
			raceAssertUtil.assertPilot(sco158, 3, 0, false, 7, 7);
			raceAssertUtil.assertPilot(sco060, 3, 0, false, 8, 8);
			raceAssertUtil.assertPilot(sco087, 3, 0, false, 9, 9);
			raceAssertUtil.assertPilot(sco116, 3, 0, false, 10, 10);
			raceAssertUtil.assertPilot(sco249, 3, 0, false, 11, 11);
			raceAssertUtil.assertPilot(sco081, 0, 0, true, 16, 12);
			raceAssertUtil.assertPilot(sco153, 0, 0, false, 16, 12);
			raceAssertUtil.assertPilot(sco179, 0, 0, true, 16, 12);
			raceAssertUtil.assertPilot(sco808, 0, 0, false, 16, 12);
