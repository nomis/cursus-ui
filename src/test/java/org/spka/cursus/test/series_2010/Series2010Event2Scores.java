...
public class Series2010Event2Scores extends Series2010Event1Scores {
	...
	public void checkSeries() throws Exception {
		...
		try {
			...
			race3AssertUtil.assertPilot(sco197, 0, 0, 13, 15);
			race3AssertUtil.assertPilot(sco808, 1, 0, 14, 16);
	...
	public void checkEvent2() throws Exception {
		...
		try {
			...
			race4AssertUtil.assertPilot(sco081, 1, 0, 8, 8);
			race4AssertUtil.assertPilot(sco019, 0, 0, 14, 9);
			race4AssertUtil.assertPilot(sco060, 0, 0, 14, 9);
			race4AssertUtil.assertPilot(sco153, 0, 0, 14, 9);
			race4AssertUtil.assertPilot(sco156, 0, 0, 14, 9);
			race4AssertUtil.assertPilot(sco197, 0, 0, 14, 9);
			race4AssertUtil.assertOrder();
