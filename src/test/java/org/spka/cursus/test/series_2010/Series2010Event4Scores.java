...
public class Series2010Event4Scores extends Series2010Event3Scores {
	...
	public void checkSeries() throws Exception {
		...
		try {
			...
			race1AssertUtil.assertPilot(sco808, 0, 0, 3, 4);
			race1AssertUtil.assertPilot(sco159, 4, 0, 4, 5);
			race1AssertUtil.assertPilot(sco081, 4, 0, 5, 6);
			race1AssertUtil.assertPilot(sco116, 3, 0, 6, 7);
			race1AssertUtil.assertPilot(sco068, 2, 0, 7, 8);
			race1AssertUtil.assertPilot(sco087, 0, 0, 7, 9);
			race1AssertUtil.assertPilot(sco248, 2, 0, 8, 10);
			...
			race3AssertUtil.assertPilot(sco179, 0, 0, 2, 3);
			race3AssertUtil.assertPilot(sco159, 6, 0, 3, 4);
			...
			race4AssertUtil.assertPilot(sco159, 5, 0, 4, 4);
			race4AssertUtil.assertPilot(sco808, 5, 0, 5, 5);
			race4AssertUtil.assertPilot(sco116, 5, 0, 6, 6);
			race4AssertUtil.assertPilot(sco087, 4, 0, 7, 7);
			race4AssertUtil.assertPilot(sco019, 0, 0, 7, 8);
			race4AssertUtil.assertPilot(sco081, 1, 0, 8, 9);
			race4AssertUtil.assertPilot(sco060, 0, 0, 10, 10);
			...
			race5AssertUtil.assertPilot(sco179, 0, 0, 2, 3);
			race5AssertUtil.assertPilot(sco068, 6, 0, 3, 4);
			...
			race6AssertUtil.assertPilot(sco068, 6, 0, 0, 1);
			race6AssertUtil.assertPilot(sco179, 6, 0, 2, 2);
			race6AssertUtil.assertPilot(sco808, 6, 0, 3, 3);
			race6AssertUtil.assertPilot(sco159, 6, 0, 4, 4);
			race6AssertUtil.assertPilot(sco200, 6, 0, 5, 5);
			race6AssertUtil.assertPilot(sco081, 6, 0, 6, 6);
			race6AssertUtil.assertPilot(sco116, 6, 0, 7, 7);
			race6AssertUtil.assertPilot(sco087, 6, 0, 8, 8);
			race6AssertUtil.assertPilot(sco136, 6, 0, 9, 9);
			race6AssertUtil.assertPilot(sco248, 6, 0, 10, 10);
			race6AssertUtil.assertPilot(sco249, 5, 0, 11, 11);
			race6AssertUtil.assertPilot(sco019, 4, 0, 12, 12);
			race6AssertUtil.assertPilot(sco018, 2, 0, 13, 13);
			race6AssertUtil.assertPilot(sco042, 0, 0, 16, 14);
			race6AssertUtil.assertPilot(sco060, 0, 0, 16, 14);
			race6AssertUtil.assertPilot(sco153, 0, 0, 16, 14);
			race6AssertUtil.assertPilot(sco156, 0, 0, 16, 14);
			race6AssertUtil.assertPilot(sco158, 0, 0, 16, 14);
			race6AssertUtil.assertPilot(sco197, 0, 0, 16, 14);
			race6AssertUtil.assertOrder();

			RaceAssertUtil race7AssertUtil = new RaceAssertUtil(scores, race7);
			race7AssertUtil.assertPilot(sco200, 4, 0, 0, 1);
			race7AssertUtil.assertPilot(sco808, 4, 0, 2, 2);
			race7AssertUtil.assertPilot(sco159, 4, 0, 3, 3);
			race7AssertUtil.assertPilot(sco018, 4, 0, 4, 4);
			race7AssertUtil.assertPilot(sco087, 4, 0, 5, 5);
			race7AssertUtil.assertPilot(sco136, 4, 0, 6, 6);
			race7AssertUtil.assertPilot(sco068, 4, 0, 7, 7);
			race7AssertUtil.assertPilot(sco248, 4, 0, 8, 8);
			race7AssertUtil.assertPilot(sco081, 4, 0, 9, 9);
			race7AssertUtil.assertPilot(sco116, 4, 0, 10, 10);
			race7AssertUtil.assertPilot(sco249, 4, 0, 11, 11);
			race7AssertUtil.assertPilot(sco179, 3, 0, 12, 12);
			race7AssertUtil.assertPilot(sco019, 3, 0, 13, 13);
			race7AssertUtil.assertPilot(sco153, 2, 0, 14, 14);
			race7AssertUtil.assertPilot(sco156, 1, 0, 15, 15);
			race7AssertUtil.assertPilot(sco042, 0, 0, 16, 16);
			race7AssertUtil.assertPilot(sco060, 0, 0, 16, 16);
			race7AssertUtil.assertPilot(sco158, 0, 0, 16, 16);
			race7AssertUtil.assertPilot(sco197, 0, 0, 16, 16);
			race7AssertUtil.assertOrder();

			RaceAssertUtil race8AssertUtil = new RaceAssertUtil(scores, race8);
			race8AssertUtil.assertPilot(sco179, 8, 0, 0, 1);
			race8AssertUtil.assertPilot(sco081, 8, 0, 2, 2);
			race8AssertUtil.assertPilot(sco248, 8, 0, 3, 3);
			race8AssertUtil.assertPilot(sco808, 7, 0, 4, 4);
			race8AssertUtil.assertPilot(sco249, 6, 0, 5, 5);
			race8AssertUtil.assertPilot(sco068, 5, 0, 6, 6);
			race8AssertUtil.assertPilot(sco159, 4, 0, 7, 7);
			race8AssertUtil.assertPilot(sco087, 4, 0, 8, 8);
			race8AssertUtil.assertPilot(sco153, 3, 0, 9, 9);
			race8AssertUtil.assertPilot(sco116, 2, 0, 10, 10);
			race8AssertUtil.assertPilot(sco018, 0, 0, 16, 11);
			race8AssertUtil.assertPilot(sco019, 0, 0, 16, 11);
			race8AssertUtil.assertPilot(sco042, 0, 0, 16, 11);
			race8AssertUtil.assertPilot(sco060, 0, 0, 16, 11);
			race8AssertUtil.assertPilot(sco136, 0, 0, 16, 11);
			race8AssertUtil.assertPilot(sco156, 0, 0, 16, 11);
			race8AssertUtil.assertPilot(sco158, 0, 0, 16, 11);
			race8AssertUtil.assertPilot(sco197, 0, 0, 16, 11);
			race8AssertUtil.assertPilot(sco200, 0, 0, 16, 11);
			race8AssertUtil.assertOrder();
