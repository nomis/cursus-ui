...
public class Series2012Event3Scores extends Series2012Event2Scores {
	...
	public final void checkRace13() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(sco159, 8, 0, false, 5, 5);
			raceAssertUtil.assertPilot(sco315, 7, 0, false, 6, 6);
			raceAssertUtil.assertPilot(sco200, 7, 0, false, 7, 7);
			raceAssertUtil.assertPilot(sco808, 6, 1, false, 8, 8);
			raceAssertUtil.assertPilot(sco666, 5, 0, false, 9, 9);
			raceAssertUtil.assertPilot(sco060, 4, 0, false, 10, 10);
			raceAssertUtil.assertPilot(sco153, 4, 0, false, 11, 11);
			raceAssertUtil.assertPilot(sco117, 3, 0, false, 12, 12);
			raceAssertUtil.assertPilot(sco320, 2, 0, false, 13, 13);
			raceAssertUtil.assertPilot(sco777, 1, 0, false, 14, 14);
			raceAssertUtil.assertPilot(sco018, 0, 0, false, 20, 15);
			raceAssertUtil.assertPilot(sco076, 0, 0, false, 20, 15);
			raceAssertUtil.assertPilot(sco081, 0, 0, false, 20, 15);
			raceAssertUtil.assertPilot(sco156, 0, 0, false, 20, 15);
			raceAssertUtil.assertPilot(sco561, 0, 0, false, 20, 15);
	...
	public final void checkRace14() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(sco808, 9, 0, false, 2, 2);
			raceAssertUtil.assertPilot(sco116, 9, 0, false, 3, 3);
			...
			raceAssertUtil.assertPilot(sco315, 7, 0, false, 8, 8);
			raceAssertUtil.assertPilot(sco060, 6, 0, false, 9, 9);
			raceAssertUtil.assertPilot(sco117, 6, 0, false, 10, 10);
			raceAssertUtil.assertPilot(sco666, 5, 0, false, 11, 11);
			raceAssertUtil.assertPilot(sco777, 4, 0, false, 12, 12);
			raceAssertUtil.assertPilot(sco018, 4, 0, false, 13, 13);
			raceAssertUtil.assertPilot(sco561, 2, 0, false, 14, 14);
			raceAssertUtil.assertPilot(sco076, 0, 0, false, 20, 15);
			raceAssertUtil.assertPilot(sco081, 0, 0, false, 20, 15);
			raceAssertUtil.assertPilot(sco153, 0, 0, false, 20, 15);
			raceAssertUtil.assertPilot(sco156, 0, 0, false, 20, 15);
	...
	public final void checkRace15() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(sco159, 8, 1, false, 4, 4);
			raceAssertUtil.assertPilot(sco179, 7, 0, false, 5, 5);
			raceAssertUtil.assertPilot(sco116, 7, 0, false, 6, 6);
			raceAssertUtil.assertPilot(sco528, 6, 0, false, 7, 7);
			raceAssertUtil.assertPilot(sco666, 5, 0, false, 8, 8);
			raceAssertUtil.assertPilot(sco315, 4, 0, false, 9, 9);
			raceAssertUtil.assertPilot(sco060, 3, 0, false, 10, 10);
			raceAssertUtil.assertPilot(sco777, 2, 0, false, 11, 11);
			raceAssertUtil.assertPilot(sco153, 1, 0, false, 12, 12);
			raceAssertUtil.assertPilot(sco018, 0, 0, false, 20, 13);
			raceAssertUtil.assertPilot(sco076, 0, 0, false, 20, 13);
			raceAssertUtil.assertPilot(sco081, 0, 0, false, 20, 13);
			raceAssertUtil.assertPilot(sco117, 0, 0, false, 20, 13);
			raceAssertUtil.assertPilot(sco156, 0, 0, false, 20, 13);
			raceAssertUtil.assertPilot(sco320, 0, 0, false, 20, 13);
			raceAssertUtil.assertPilot(sco561, 0, 0, false, 20, 13);
			raceAssertUtil.assertDone(0);
