...
public class Series2012Event2Scores extends Series2012Event1Scores {
	...
	public final void checkRace7() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(sco018, 4, 0, false, 9, 9);
			raceAssertUtil.assertPilot(sco081, 3, 0, false, 10, 10);
			raceAssertUtil.assertPilot(sco087, 3, 0, false, 11, 11);
			raceAssertUtil.assertPilot(sco315, 3, 0, false, 12, 12);
			raceAssertUtil.assertPilot(sco060, 2, 0, false, 13, 13);
			raceAssertUtil.assertPilot(sco076, 0, 0, false, 18, 14);
			raceAssertUtil.assertPilot(sco153, 0, 0, false, 18, 14);
			raceAssertUtil.assertPilot(sco156, 0, 0, false, 18, 14);
			raceAssertUtil.assertPilot(sco528, 0, 0, false, 18, 14);
	...
	public final void checkRace8() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(sco808, 6, 1, false, 3, 3);
			...
			raceAssertUtil.assertPilot(ir181, 5, 0, false, 8, 8);
			raceAssertUtil.assertPilot(sco081, 5, 0, false, 9, 9);
			raceAssertUtil.assertPilot(sco018, 5, 0, false, 10, 10);
			raceAssertUtil.assertPilot(sco528, 4, 0, false, 11, 11);
			raceAssertUtil.assertPilot(sco315, 4, 0, false, 12, 12);
			raceAssertUtil.assertPilot(sco087, 3, 0, false, 13, 13);
			raceAssertUtil.assertPilot(sco060, 2, 0, false, 14, 14);
			raceAssertUtil.assertPilot(sco076, 0, 0, false, 18, 15);
			raceAssertUtil.assertPilot(sco153, 0, 0, false, 18, 15);
	...
	public final void checkRace9() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(sco100, 5, 0, false, 8, 8);
			raceAssertUtil.assertPilot(sco159, 4, 0, false, 9, 9);
			raceAssertUtil.assertPilot(sco666, 4, 0, false, 10, 10);
			raceAssertUtil.assertPilot(sco018, 4, 0, false, 11, 11);
			raceAssertUtil.assertPilot(sco087, 4, 0, false, 12, 12);
			raceAssertUtil.assertPilot(sco315, 4, 0, false, 13, 13);
	...
	public final void checkRace10() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(ir181, 9, 0, false, 0, 1);
			raceAssertUtil.assertPilot(sco179, 9, 0, false, 2, 2);
			raceAssertUtil.assertPilot(sco200, 9, 1, false, 3, 3);
			raceAssertUtil.assertPilot(sco116, 9, 0, false, 4, 4);
			raceAssertUtil.assertPilot(sco808, 9, 0, false, 5, 5);
			raceAssertUtil.assertPilot(sco528, 8, 0, false, 6, 6);
			raceAssertUtil.assertPilot(sco159, 7, 0, false, 7, 7);
			raceAssertUtil.assertPilot(sco666, 7, 0, false, 8, 8);
			raceAssertUtil.assertPilot(sco087, 6, 0, false, 9, 9);
			raceAssertUtil.assertPilot(sco018, 6, 0, false, 10, 10);
			raceAssertUtil.assertPilot(sco315, 5, 0, false, 11, 11);
			raceAssertUtil.assertPilot(sco100, 4, 0, false, 12, 12);
			raceAssertUtil.assertPilot(sco060, 1, 0, false, 13, 13);
			raceAssertUtil.assertPilot(sco076, 0, 0, false, 18, 14);
			raceAssertUtil.assertPilot(sco081, 0, 0, false, 18, 14);
			raceAssertUtil.assertPilot(sco153, 0, 0, false, 18, 14);
			raceAssertUtil.assertPilot(sco156, 0, 0, false, 18, 14);
			raceAssertUtil.assertDone(0);
	...
	public final void checkRace11() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(sco179, 9, 0, false, 2, 2);
			raceAssertUtil.assertPilot(ir181, 9, 0, false, 3, 3);
			raceAssertUtil.assertPilot(sco808, 9, 0, false, 4, 4);
			raceAssertUtil.assertPilot(sco116, 9, 0, false, 5, 5);
			raceAssertUtil.assertPilot(sco528, 8, 0, false, 6, 6);
			raceAssertUtil.assertPilot(sco666, 8, 0, false, 7, 7);
			...
			raceAssertUtil.assertPilot(sco018, 0, 0, false, 18, 14);
			raceAssertUtil.assertPilot(sco076, 0, 0, false, 18, 14);
			raceAssertUtil.assertPilot(sco153, 0, 0, false, 18, 14);
			raceAssertUtil.assertPilot(sco156, 0, 0, false, 18, 14);
			raceAssertUtil.assertDone(0);
	...
	public final void checkRace12() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(sco200, 9, 0, false, 0, 1);
			raceAssertUtil.assertPilot(ir181, 9, 0, false, 2, 2);
			raceAssertUtil.assertPilot(sco808, 9, 0, false, 3, 3);
			raceAssertUtil.assertPilot(sco179, 9, 0, false, 4, 4);
			raceAssertUtil.assertPilot(sco528, 9, 0, false, 5, 5);
			raceAssertUtil.assertPilot(sco116, 9, 0, false, 6, 6);
			raceAssertUtil.assertPilot(sco666, 8, 1, false, 7, 7);
			raceAssertUtil.assertPilot(sco159, 8, 0, false, 8, 8);
			raceAssertUtil.assertPilot(sco060, 6, 0, false, 9, 9);
			raceAssertUtil.assertPilot(sco087, 4, 0, false, 10, 10);
			raceAssertUtil.assertPilot(sco018, 4, 0, false, 11, 11);
			raceAssertUtil.assertPilot(sco076, 0, 0, false, 18, 12);
			raceAssertUtil.assertPilot(sco081, 0, 0, false, 18, 12);
			raceAssertUtil.assertPilot(sco100, 0, 0, false, 18, 12);
			raceAssertUtil.assertPilot(sco153, 0, 0, false, 18, 12);
			raceAssertUtil.assertPilot(sco156, 0, 0, false, 18, 12);
			raceAssertUtil.assertPilot(sco315, 0, 0, false, 18, 12);
			raceAssertUtil.assertDone(0);
